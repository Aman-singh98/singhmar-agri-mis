...
//     // ✅ NEW: Upload ke baad jinke paas miNumber hai unka applicationStatus sync karo
//     const miNumbers = [
...
//     // ✅ NEW: MI number set hai to applicationStatus sync karo
//     if (doc.miNumber) {
...
//     // ✅ NEW: Update ke baad miNumber se applicationStatus sync karo
//     if (updated.miNumber) {
//       await syncApplicationStatus(updated.miNumber);

//       // Sync ke baad fresh data fetch karo (applicationStatus updated hoga)
