...
// function validateEntry({ dealerName, farmerDealerCode, amount, financialYear }) {
...
//  */
// function createHandlers(Model, label) {
//    /* ── GET all ── */
...
//          const validationError = validateEntry({ dealerName, farmerDealerCode, amount, financialYear });
//          if (validationError) {
...
// const incentive = createHandlers(Incentive, "Incentive");
