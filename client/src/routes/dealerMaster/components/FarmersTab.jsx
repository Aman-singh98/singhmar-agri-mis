...
//   // ─── layout: full height flex column, only tbody scrolls ─────────────────
//   // The outer wrapper fills whatever height the parent gives it (h-full).
//   // Filter bar + table header are fixed; tbody gets overflow-y-auto.
//   return (
...
//               className="px-3 py-1.5 border border-slate-200 bg-white text-slate-800 text-sm font-semibold outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 cursor-pointer"
//             >
...
//         <div className="flex gap-3 flex-wrap items-center px-5 py-3">
//           {isControlled && (
...
//             className="min-w-[220px] px-3 py-2 border-2 border-slate-200 bg-white text-slate-700 text-sm font-medium outline-none focus:border-green-500 cursor-pointer"
//           >
...
//               placeholder="Search farmer name or MI number…"
...
//             </svg>
//             <p className="text-sm">Select a dealer above to view their farmers</p>
//           </div>
//         )}
...
//             {/* thead is NOT sticky here — it stays fixed because it's
//                 inside the scrollable div and we use a separate fixed
//                 header approach via the outer flex-none block above.
//                 Instead we simply render thead once at top of table. */}
//             <thead>
