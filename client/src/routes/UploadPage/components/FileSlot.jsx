...
//          onDragOver={selectedYear ? onDragOver : e => e.preventDefault()}
//          onDragLeave={selectedYear ? onDragLeave : undefined}
//          onDrop={selectedYear ? onDrop : e => e.preventDefault()}
//          onClick={() => selectedYear && document.getElementById(`input-${type.key}`)?.click()}
//          onKeyDown={e => selectedYear && (e.key === "Enter" || e.key === " ") && document.getElementById(`input-${type.key}`)?.click()}
//          className={`group flex items-center gap-3 p-3 border-2 border-dashed transition-all select-none
//             ${!selectedYear
//                ? "border-gray-200 bg-gray-50 cursor-not-allowed opacity-50"  // ✅ disabled look
//                : isDragOver
...
//                {!selectedYear
//                   ? "Select a financial year first"  // ✅ message
