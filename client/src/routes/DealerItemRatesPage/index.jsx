...
//    // Derive full dealer object from Redux store by name
...
//    // ── Delete state ──────────────────────────────────────────────────────────
//    const [deleteTarget, setDeleteTarget] = useState(null); // { _id, itemName }
...
//             <p className="text-xs uppercase tracking-widest text-green-700 font-semibold mb-0.5">
//                Pricing
//             </p>
//             <h1 className="text-xl font-bold text-black tracking-tight">Dealer Rate Overrides</h1>
//             <p className="text-xs text-black mt-0.5">Set custom item rates for each dealer</p>
//          </div>
...
//                   className="flex items-center gap-2 bg-green-600 px-4 py-2 text-sm font-semibold
...
//          {selectedDealer && selectedFy && !loading && (
//             <div className="flex-none bg-white border-b px-6 py-3">
...
//                      {filteredRates.length} override{filteredRates.length !== 1 ? "s" : ""}
//                      {rates.length !== filteredRates.length && ` (filtered from ${rates.length})`}
//                   </span>
...
//                         className="ml-auto w-56 border px-3 py-1.5 text-sm text-black
...
//                   <Spinner />
//                ) : tableError ? (
//                   <p className="py-10 text-center text-sm text-black">{tableError}</p>
...
//                         <tr>
//                            <th className="px-5 py-3 text-left text-xs font-semibold text-black uppercase tracking-wide w-10">
//                               #
//                            </th>
//                            <th className="px-5 py-3 text-left text-xs font-semibold text-black uppercase tracking-wide">
//                               Item Name
//                            </th>
//                            <th className="px-5 py-3 text-right text-xs font-semibold text-black uppercase tracking-wide">
//                               Rate Upto
//                            </th>
//                            <th className="px-5 py-3 text-right text-xs font-semibold text-black uppercase tracking-wide">
//                               Rate From
...
//                            <tr key={rate._id} className="hover:bg-green-50 transition-colors">
//                               <td className="px-5 py-3 text-black tabular-nums">{idx + 1}</td>
//                               <td className="px-5 py-3 font-medium text-black">{rate.itemName}</td>
//                               <td className="px-5 py-3 text-right tabular-nums text-black">
//                                  ₹ {rate.rateUpto.toFixed(2)}
//                               </td>
//                               <td className="px-5 py-3 text-right tabular-nums text-black">
//                                  ₹ {rate.rateFrom.toFixed(2)}
//                               </td>
...
//                                        className="border border-red-300 px-3 py-1 text-xs font-medium
