...
// import { HiTrash, HiPlus, HiSearch, HiCalendar } from "react-icons/hi";
// import { useFinancialYears } from "../../hooks/useFinancialYears";
// import ConfirmDialog from "./ConfirmDialog";
// import Pagination from "../Pagination";

// const LIMIT = 8;
// const FY_REGEX = /^\d{2}-\d{2}$/;
...
//       if (!FY_REGEX.test(val)) { setInputError("Format must be YY-YY (e.g. 26-27)"); return; }
...
//          {/* ── Add Year card ────────────────────────────────────── */}
//          <div className="bg-white border border-slate-200 shadow-sm p-4 sm:p-5 flex flex-col gap-3">
//             <div>
//                <label className="text-xs font-semibold uppercase tracking-widest text-slate-500">
//                   Add Financial Year
//                </label>
//                <p className="text-xs text-slate-400 mt-0.5">Enter in YY-YY format, e.g. 26-27</p>
//             </div>
...
//                         maxLength={5}
//                         className={`w-full pl-9 pr-3 py-2 border text-sm bg-white text-slate-800 font-mono
...
//                               : "border-slate-300 focus:ring-green-400 focus:border-green-500"}`}
//                      />
//                   </div>
//                   {inputError && (
...
//                <button
//                   onClick={handleAdd}
//                   className="flex items-center justify-center gap-1.5 px-4 py-2 bg-green-700 text-white text-sm font-semibold hover:bg-green-600 active:bg-green-800 transition shrink-0 shadow-sm"
//                >
...
//                            <th className="px-4 md:px-5 py-3 text-left font-semibold text-slate-500 text-xs uppercase tracking-wide w-12">
//                               S.No
//                            </th>
//                            <th className="px-4 md:px-5 py-3 text-left font-semibold text-slate-500 text-xs uppercase tracking-wide">
//                               Year
//                            </th>
//                            <th className="px-4 md:px-5 py-3 text-left font-semibold text-slate-500 text-xs uppercase tracking-wide">
//                               Status
//                            </th>
//                            <th className="px-4 md:px-5 py-3 text-center font-semibold text-slate-500 text-xs uppercase tracking-wide">
//                               Actions
//                            </th>
//                         </tr>
//                      </thead>
