/**
 * ItemRates.js  —  Frontend constants (mirrors server/constant/ItemRates.js)
 *
 * Keep this file in sync with the backend whenever items are added/removed.
 * Two items exist in the backend but NOT in ITEM_Rate_List.xlsx (no price yet):
 *   • 75 MM Connector TAIL    (key: "75MmConnectorTail")
 *   • 75 MM Connector Coupler (key: "75MmConnectorCoupler")
 */

// ── HDPE pipe inventory product keys ─────────────────────────────────────────
export const HDPE_ITEM_KEYS = [
...
export const LATERAL32_ITEM_KEYS = [
...
export const FITTINGS_ITEM_KEYS = [
   "12MmEndCap",
   "12MmLateralPlain",
   "16MmBallValve",
   "16MmEndCap",
...
export const SPRINKLER_ITEM_KEYS = [
...
export const ALUMINIUM_ITEM_KEYS = [
   "75MmAlmPipe3Mtr",
   "75MmAluminiumBend",
...
// ── PVC pipes ─────────────────────────────────────────────────────────────────
export const PVC_PIPE_ITEM_KEYS = [
   "63X4KgPvcPipe",
   "75X4KgPvcPipe",
];

// ── Inline laterals (12MM / 16MM) ─────────────────────────────────────────────
export const INLINE_LATERAL_ITEM_KEYS = [
   "16MmInLineLateral",
...
// Total: 121 keys (119 from ITEM_Rate_List.xlsx + 2 new alias items not yet in xlsx)
export const KEY_TO_ITEM_NAME = {
   // 12 MM
   ...
   "75MmConnectorCoupler": "75 MM Connector Coupler",   // ⚠ not in xlsx yet
   "75MmConnectorTail": "75 MM Connector TAIL",      // ⚠ not in xlsx yet
